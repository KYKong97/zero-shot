...
class BasePixelDecoder(nn.Module):
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        ret["transformer_in_features"] = cfg.MODEL.MASK_FORMER.TRANSFORMER_IN_FEATURE
        return ret
    ...
    def forward_features(self, features):
        ...
        if self.transformer_in_features=="multi_scale_pixel_decoder":

            return self.mask_features(y), None, multi_scale_features
        else:
            return self.mask_features(y),None,None
